...
display.recipe = function(fpath) {
  ...
  formatted_ingredients = paste("-", ingredients)
  
  instructions = recipe$instructions
  formatted_instructions = paste("-", instructions)
